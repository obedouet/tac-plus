...
void send_authen_reply(int status, char *msg, u_short msg_len, char *data, u_short data_len, u_char flags);
u_char *get_authen_continue();
...
void send_authen_reply(status, msg, msg_len, data, data_len, flags)
int status;
char *msg;
u_short msg_len;
char *data;
