...
ChangeLog:
 - 2009/04/12: added includes for stdlib.h and string.h
 - 2010/1/29: added remoteacl
 - 2010/2/22: added ldap.h and others #ifndef checks
*/
/* For autoconfig */
#include "config.h"
...
#define VERSION "F4.0.3.alpha.v9.09 (Extended Tac_plus)"
...
#define FLAG_SEEN    4          /* for circular definition detection */
    ...
    char *remoteacl;            /* remote hosts (NASs) to allow/deny login */
#endif
...
extern void send_authen_reply(int status, char *msg, u_short msg_len, char *data, u_short data_len, u_char flags);
...
extern void *hash_get_entry(void **hashtab, int i);
