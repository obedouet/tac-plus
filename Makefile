...
CC = gcc
CPPFLAGS =  
FLAGS = $(CPPFLAGS) -g -O2 -m32
LDFLAGS = 
OSLIBS = -llber -lc -lcrypt -lnsl  -lldap -lssl 
DEFINES = -DUSE_LDAP -DACLS
OS = -DLINUX -DGLIBC
...
SRCS =	acct.c authen.c author.c choose_authen.c config.c do_acct.c \
	...
	db.c db_null.c db_mysql.c db_pgsql.c tcpwrap.c ldap.c time_limit.c mem.c
...
tac_plus_static: $(OBJS) $(LIBS) generate_passwd
	$(CC) -o tac_plus -static-libgcc $(CFLAGS) $(OBJS) $(LIBS) $(OSLIBS) 
	strip tac_plus
