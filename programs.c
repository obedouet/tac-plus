...
ChangeLog:
 - 2009/04/12: Check return of write() for interrupts when writing arguments to
          external scripts. (from Cisco's version F4.0.4.16)
*/
